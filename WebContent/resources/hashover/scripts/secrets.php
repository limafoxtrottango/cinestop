<?php
	...
	$encryption_key		= 'Q1W2E3R4T5Y6U7I8O9P0A1S2D3F4G5H6';			// Unique 8 to 32 character encryption key
	$notification_email	= 'pp62091@gmail.com';	// E-mail for notification of new comments
	$admin_nickname		= 'pandepra';			// Nickname with admin rights (must be title-cased)
	$admin_password		= 'pandepra';			// Password to gain admin rights
